...
# Import Xilinx IP
import_ip -files $env(FYP_DIR)/hw/xilinx_ip/axi_L_register_control_crossbar.xci
import_ip -files $env(FYP_DIR)/hw/xilinx_ip/axi_memory_interconnect.xci
import_ip -files $env(FYP_DIR)/hw/xilinx_ip/axi_memory_master_vip.xci
import_ip -files $env(FYP_DIR)/hw/xilinx_ip/axil_master_vip.xci
import_ip -files $env(FYP_DIR)/hw/xilinx_ip/fp_add.xci
import_ip -files $env(FYP_DIR)/hw/xilinx_ip/fp_mult.xci
import_ip -files $env(FYP_DIR)/hw/xilinx_ip/aggregation_buffer_sdp_bram.xci
import_ip -files $env(FYP_DIR)/hw/xilinx_ip/transformation_buffer_sdp_bram.xci
import_ip -files $env(FYP_DIR)/hw/xilinx_ip/scale_factor_queue.xci
import_ip -files $env(FYP_DIR)/hw/xilinx_ip/ddr4_0.xcix
