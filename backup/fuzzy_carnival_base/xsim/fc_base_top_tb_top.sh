...
#
# Filename    : fc_base_top_tb_top.sh
...
#
# Generated by Vivado on Fri Dec 30 20:14:36 GMT 2022
# SW Build 2729669 on Thu Dec  5 04:48:12 MST 2019
#
# Copyright 1986-2019 Xilinx, Inc. All Rights Reserved. 
#
# usage: fc_base_top_tb_top.sh [-help]
# usage: fc_base_top_tb_top.sh [-lib_map_path]
# usage: fc_base_top_tb_top.sh [-noclean_files]
# usage: fc_base_top_tb_top.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "fc_base_top_tb_top.sh - Script generated by export_simulation (Vivado v2019.2.1 (64-bit)-id)\n"
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fc_base_top_tb_top.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fc_base_top_tb_top.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fc_base_top_tb_top.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: fc_base_top_tb_top.sh [-help]\n\
Usage: fc_base_top_tb_top.sh [-lib_map_path]\n\
Usage: fc_base_top_tb_top.sh [-reset_run]\n\
Usage: fc_base_top_tb_top.sh [-noclean_files]\n\n\
