...
#
# Generated by Vivado on Fri May 19 14:33:53 BST 2023
# SW Build 2708876 on Wed Nov  6 21:39:14 MST 2019
#
# Copyright 1986-2019 Xilinx, Inc. All Rights Reserved. 
#
# usage: fixed16_upsampler.sh [-help]
# usage: fixed16_upsampler.sh [-lib_map_path]
# usage: fixed16_upsampler.sh [-noclean_files]
# usage: fixed16_upsampler.sh [-reset_run]
#
...
# executing this script. Please type 'fixed16_upsampler.sh -help' for more information.
#
...
# Script info
echo -e "fixed16_upsampler.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../ip/fixed16_upsampler/sim/fixed16_upsampler.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fixed16_upsampler xil_defaultlib.glbl -o fixed16_upsampler_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fixed16_upsampler_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fixed16_upsampler.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/scratch/pg519/fc_wa1/hw/hw.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key fixed16_upsampler_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fixed16_upsampler_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fixed16_upsampler.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: fixed16_upsampler.sh [-help]\n\
Usage: fixed16_upsampler.sh [-lib_map_path]\n\
Usage: fixed16_upsampler.sh [-reset_run]\n\
Usage: fixed16_upsampler.sh [-noclean_files]\n\n\
