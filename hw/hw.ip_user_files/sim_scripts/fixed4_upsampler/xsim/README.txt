...
#
# Generated by export_simulation on Fri May 19 14:40:10 BST 2023
#
################################################################################
...
'-reset_run' switch to the './fixed4_upsampler.sh' script.

./fixed4_upsampler.sh -reset_run
...
./fixed4_upsampler.sh -noclean_files

For more information on the script, please type './fixed4_upsampler.sh -help'.
