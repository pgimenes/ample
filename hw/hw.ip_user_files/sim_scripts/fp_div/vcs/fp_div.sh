...
#
# Generated by Vivado on Sun Mar 12 17:46:59 GMT 2023
# SW Build 2708876 on Wed Nov  6 21:39:14 MST 2019
#
# Copyright 1986-2019 Xilinx, Inc. All Rights Reserved. 
#
# usage: fp_div.sh [-help]
# usage: fp_div.sh [-lib_map_path]
# usage: fp_div.sh [-noclean_files]
# usage: fp_div.sh [-reset_run]
#
...
# executing this script. Please type 'fp_div.sh -help' for more information.
#
...
# Script info
echo -e "fp_div.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../ip/fp_div/sim/fp_div.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp_div xil_defaultlib.glbl -o fp_div_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fp_div_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fp_div.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key fp_div_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fp_div_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fp_div.sh -help\" for more information)\n"
    exit 1
  fi
