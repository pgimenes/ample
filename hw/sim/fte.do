...
add wave -noupdate -subitemconfig {{/top_wrapper_tb/top_i/transformation_engine_i/genblk1[0]/feature_transformation_core_i/sys_module_forward_valid[0]} -expand} {/top_wrapper_tb/top_i/transformation_engine_i/genblk1[0]/feature_transformation_core_i/sys_module_forward_valid}
add wave -noupdate -subitemconfig {{/top_wrapper_tb/top_i/transformation_engine_i/genblk1[0]/feature_transformation_core_i/sys_module_forward[0]} -expand} {/top_wrapper_tb/top_i/transformation_engine_i/genblk1[0]/feature_transformation_core_i/sys_module_forward}
...
WaveRestoreCursors {{Cursor 1} {7220827 ps} 0} {Trace {453050162 ps} 0}
...
update
WaveRestoreZoom {0 ps} {17892001 ps}
