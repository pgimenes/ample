...
module mesh #(
    ...
    input  logic [MESH_SIZE_X-1:0][MESH_SIZE_Y-1:0]              is_valid_i,
    output logic [MESH_SIZE_X-1:0][MESH_SIZE_Y-1:0][VC_NUM-1:0]  is_allocatable_o,
    input noc_params::flit_t [MESH_SIZE_X-1:0][MESH_SIZE_Y-1:0]  data_i,

    input  logic [MESH_SIZE_X-1:0][MESH_SIZE_Y-1:0][VC_NUM-1:0]  is_on_off_i,
    output logic [MESH_SIZE_X-1:0][MESH_SIZE_Y-1:0]              is_valid_o,
    input  logic [MESH_SIZE_X-1:0][MESH_SIZE_Y-1:0][VC_NUM-1:0]  is_allocatable_i,
    output noc_params::flit_t [MESH_SIZE_X-1:0][MESH_SIZE_Y-1:0] data_o
);
