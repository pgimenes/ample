...
parameter MAX_NODESLOT_COUNT = 64; //256 4 Jul -
parameter MAX_NEIGHBOURS = 64; //1024 4 Jul -
parameter MAX_FEATURE_COUNT = 1024; //1024 4 Jul Don't change this - breaks sim
parameter FEATURE_COUNT = 64; 

parameter NODE_ID_WIDTH = $clog2(MAX_NODES); // 20

parameter LARGE_FEATURE_COUNT = 64; //1024 4 Jul
...
// HBM
parameter HBM_BANKS = 32; //16 4 Jul
